...
namespace RTEditor
{
    ...
    public abstract class Gizmo : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField]
        protected Color[] _axesColors = new Color[3] { Color.red, Color.green, Color.blue };
        ...
        /// </summary>
        [SerializeField]
        protected float _gizmoBaseScale = 1.0f;
        ...
        /// <summary>
        /// The material which is used to render gizmo lines.
        /// </summary>
        ...
        {
            // Cache needed camera data
            _camera = EditorCamera.Instance.Camera;
            _cameraTransform = _camera.transform;

            // Perform initializations
            _gizmoTransform = transform;
            _lineRenderingMaterial = new Material(Shader.Find("Gizmo Line Rendering"));
            ...
            _lineRenderingMaterial.SetInt("_StencilRefValue", _doNotUseStencil);
        }
        ...
        protected void UpdateShaderStencilRefValuesForGizmoAxisLineDraw(int axisIndex, Vector3 startPoint, Vector3 endPoint, float gizmoScale)
        {
            ...
            float t;
            if (axisCapPlane.Raycast(rayAimingAtCameraPosition, out t)) _lineRenderingMaterial.SetInt("_StencilRefValue", _axesStencilRefValues[axisIndex]);
            else _lineRenderingMaterial.SetInt("_StencilRefValue", _doNotUseStencil);
        }
